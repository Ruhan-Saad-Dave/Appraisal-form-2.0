...
const withApprovalChain = (school) => {
  if (!school.track && !school.deanTrack) return school; // CISR (and anything track-less): leave untouched.
  const normalizedSchool = {
    ...school,
    track: school.track || school.deanTrack,
    deanTrack: school.deanTrack || school.track,
